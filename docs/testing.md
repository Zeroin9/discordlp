...
|---|---|
| `PariServiceTest` | Валидацию и правила приема ставок, переходы статусов, права автора, фиксацию итогов и комиссии |
| `PariPayoutCalculatorTest` | Тотализаторную арифметику: комиссию, призовой фонд, коэффициент, округление выплат вниз и отсутствие переполнения |
| `PariOddsTest` | Коэффициенты по текущему состоянию пула |
| `PariPayoutProcessorTest` | Выплату доли призового фонда, возврат при отсутствии победителей и отказ от повторного начисления |
...
- деление призового фонда между победителями пропорционально ставкам и обнуление
  проигравшей ставки;
- единственный победитель забирает весь призовой фонд;
- возврат всем, если на победивший вариант никто не поставил;
